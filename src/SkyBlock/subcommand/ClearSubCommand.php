...
class ClearSubCommand extends SubCommand
{
	...
	public function execute(CommandSender $sender, array $args) {
		...
		$senderIsAdmin = $sender->hasPermission("skyblock.admin.clear");
		...
		if( $argString != $clearCommandParm and ! $senderIsAdmin ) {
			...
			$msg .= TextFormat::DARK_PURPLE . "/is clear " . $clearCommandParm;
			...
			$msg .= TextFormat::WHITE . "If you really want to do this type ";
			$msg .= TextFormat::DARK_PURPLE . "/is clear " . $adminClearCommandParm;
			$sender->sendMessage($msg);
			return true;
		}
