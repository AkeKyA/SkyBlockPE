...
class AutoSubCommand extends SubCommand
{
	...
	public function execute(CommandSender $sender, array $args) {
		...
		if($this->getPlugin()->getProvider() instanceof \SkyBlock\provider\MYSQLDataProvider) {
		...
		if ($plot !== null) {
			...
			$sender->sendMessage(TextFormat::GREEN . "If you dont like this plot use the /is auto command again to find another.");
		} else {
